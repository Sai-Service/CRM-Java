...
//////TO DISPLAY MARQUEE VALUE FOR TOTAL SMS SEND ON HOME PAGE//////////////////////         
    ...
    //////TO DISPLAY TASK ID//////////////////////         
    @Query("select distinct std.taskId as taskId  from SsTaskDetails std where std.callDuDt=?1 and taskStatus='NEW' and std.locId=?2 and assigneeId is null  order by std.taskId")
    List<Object> getTaskId( Date inputDate,Integer locId);
