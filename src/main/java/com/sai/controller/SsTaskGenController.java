...
//            gatePassAll.save(ssGtPass);
     ...
     @RequestMapping(value = "/getTasksGenPSAft6Month", method = RequestMethod.GET, produces = {"application/JSON"})
    public List<SSTaskGen> getTasksGenPSAft6Month() throws Exception {
//        ObjectMapper mapper = new ObjectMapper();
        List<Map> map = taskGenImpl.getTasksGenPSAft6Month();
//        SSTaskGen pojo = mapper.convertValue(map, SSTaskGen.class);
